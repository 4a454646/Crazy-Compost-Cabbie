...
public class Skidmarks : MonoBehaviour {
	...
	[SerializeField] private int MAX_MARKS = 2048; // Max number of marks total for everyone together
	[SerializeField] private float MARK_WIDTH = 0.35f; // Width of the skidmarks. Should match the width of the wheels
	[SerializeField] private float GROUND_OFFSET = 0.02f;  // Distance above surface in metres
	[SerializeField] private float MIN_DISTANCE = 0.25f; // Distance between skid texture sections in metres. Bigger = better performance, less smooth
	[SerializeField] private float MAX_OPACITY = 1.0f; // Max skidmark opacity
	private float MIN_SQR_DISTANCE;
	...
	protected void Awake() {
		MIN_SQR_DISTANCE = MIN_DISTANCE * MIN_DISTANCE;
